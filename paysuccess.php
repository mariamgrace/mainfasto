...
<h5>Your order Confirmed!</h5> <!--<span class="font-weight-bold d-block mt-4">Hello, Chris</span> <span>You order has been confirmed!</span>
...
<p class="font-weight-bold mb-0">Thanks for choosing us!</p> <span>Team FASTO</span>
</div>
</div>
</div>
</div>
