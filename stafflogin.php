...
<body>
  ...
  <img src="./images/office.jpg" align="left" alt="Paris" style="width:40%;margin-top:80px; margin-left:60px;">
   ...
   <!--SignIn Form--> 
      <form role="form" data-toggle="validator" class="login" action="stafflogin.php" method="post">      
