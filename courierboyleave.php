...
include('dbcon.php');
session_start();
$resi= mysqli_query($con,"SELECT s.*, l.* FROM tbl_courierboy s, tbl_login l WHERE s.idnumber = l.id");//fetch data from database
while($r = mysqli_fetch_array($resi))
{
$cboyid=$r['courierboy_id']; 
