...
<div class="top_navbar">
    ...
    <center>
        <h1 style="margin-top:2%"><b>Courier Boys</b></h1>
    ...
    <!--PHP CONNECTION & FETCH CUSTOMER DETAILS-->
            ...
            <tr>     
                ...
                <td>
                    <button style="margin-left:150px"class="btn btn-effect-7"><?php if($r['status']==1){ echo '<p><a href="courierboystatus.php?id='.$r['id'].'&status=0"><b>Enable</b></a></p>';}
                    else{ echo '<p><a href="courierboystatus.php?id='.$r['id'].'&status=1"><b>Disable</b></a></p>';}?></button> 
                </td>
            </tr>	
            <?php
            }
