...
<body>
  ...
  <form role="form" data-toggle="validator" class="login" action="addcourierboy.php" method="post"> 
    <div class="addstafftable">
    <h1 style="margin-top:6%"><b><center>Add New Courier Boy</center></b></h1>
      ...
      <table style="margin-top: 60px;">
          ...
          <tr>
              <th>Courier Boy Id</th>
              <td class="form-group"><input type="text" data-minlength="6" maxlength="6" pattern="^[0-9]*$" name="courierboyid" placeholder="Enter Courier Boy ID" required></td>
  ...
  <?php
              if(isset($_POST['addstaff']))
              {
                ...
                $gender=$_POST['gender'];
                $phone=$_POST['phone'];
                $courierboyid=$_POST['courierboyid'];
                $doj=$_POST['doj'];
                $uemail=$_POST['email'];
                $pas=$_POST['password'];
                ...
                $query_run = mysqli_query($con,$query);
                    ...
                    {
                      $query="INSERT INTO `tbl_login`(`username`, `aadharid`, `password`, `email`, `role`) VALUES ('$uname','$uaadhar','$pass','$uemail','Courier Boy')";
                      $query_run = mysqli_query($con,$query);
                      ...
                      $query3="INSERT INTO `tbl_courierboy`(`courierboy_id`, `idnumber`, `fullname`, `phone`, `dob`, `gender`, `doj`) VALUES ('$courierboyid','$tblid','$fname','$phone','$dob','$gender', '$doj')";
                      $query_run3 = mysqli_query($con,$query3);

                      if($query_run3)
                      {
                      $_SESSION['status']="Courier Boy Registered Successfully";
